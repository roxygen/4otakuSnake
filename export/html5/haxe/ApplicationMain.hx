...
class ApplicationMain {
	...
	public static function main() {
		...
		//flash.Lib.setPackage("Roxygen", "NewProject1", "com.example.myapp", "0.0.1");
		...
		loaders.set("assets/images/com00001.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/com00098.png", loader);
		total ++;
